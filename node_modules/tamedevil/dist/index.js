...
exports.undefined = exports.tmp = exports.tempVar = exports.te = exports.substring = exports.subcomment = exports.set = exports.runInBatch = exports.run = exports.ref = exports.optionalGet = exports.literal = exports.lit = exports.join = exports.isTE = exports.identifier = exports.get = exports.eval = exports.dangerouslyIncludeRawCode = exports.dangerousKey = exports.compile = exports.cache = exports.batch = exports.Idents = exports.isSafeObjectPropertyName = exports.toJSON = exports.stringifyString = void 0;
    ...
    return typeof key === "string" && canAccessViaDot(key)
        ...
        : // ["@@meaning"]
            typeof key === "string" || (typeof key === "number" && Number.isFinite(key))
                ? makeRawNode(`[${(0, exports.toJSON)(key)}]`)
                : te `[${te.lit(key)}]`;
}
exports.get = get;
/**
