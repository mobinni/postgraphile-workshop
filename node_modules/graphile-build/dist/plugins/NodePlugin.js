    ...
    schema: {
        hooks: {
            ...
            GraphQLObjectType_fields(fields, build, context) {
                ...
                const { getTypeByName, extend, graphql: { GraphQLNonNull, GraphQLID }, inflection, [exports.NODE_ID_CODECS]: nodeIdCodecs, [exports.NODE_ID_HANDLER_BY_TYPE_NAME]: nodeIdHandlerByTypeName, } = build;
                const nodeIdFieldName = build.inflection.nodeIdFieldName();
                ...
                return extend(fields, {
                    node: fieldWithHooks({
                        ...
                        plan: (0, utils_js_1.EXPORTABLE)((node, nodeIdCodecs, nodeIdFieldName, nodeIdHandlerByTypeName) => function plan(_$root, args) {
                            return node(nodeIdCodecs, nodeIdHandlerByTypeName, args.get(nodeIdFieldName));
                        }, [
                            grafast_1.node,
                            nodeIdCodecs,
                            nodeIdFieldName,
