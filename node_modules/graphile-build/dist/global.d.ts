...
declare global {
    namespace GraphileBuild {
        ...
        type GrafastFieldConfigMap<TParentStep extends ExecutableStep | null, TContext extends Grafast.Context> = {
            [fieldName: string]: GrafastFieldConfig<any, TContext, TParentStep, any, any>;
        };
        /** Our take on GraphQLObjectTypeConfig that allows for plans */
        interface GrafastObjectTypeConfig<TParentStep extends ExecutableStep | null, TContext extends Grafast.Context> extends Omit<GraphQLObjectTypeConfig<unknown, TContext>, "fields" | "interfaces"> {
            fields?: GrafastFieldConfigMap<TParentStep, TContext> | ((context: ContextObjectFields) => GrafastFieldConfigMap<TParentStep, TContext>);
        ...
        interface GrafastInputObjectTypeConfig extends Omit<GraphQLInputObjectTypeConfig, "fields"> {
            fields?: GrafastInputFieldConfigMap<any, any> | ((context: ContextInputObjectFields) => GrafastInputFieldConfigMap<any, any>);
        }
        /** Our take on GraphQLUnionTypeConfig that allows for plans */
        interface GrafastUnionTypeConfig<TSource, TContext> extends Omit<GraphQLUnionTypeConfig<TSource, TContext>, "types"> {
            types?: GraphQLObjectType[] | ((context: ContextUnionTypes) => GraphQLObjectType[]);
        }
        /** Our take on GraphQLInterfaceTypeConfig that allows for plans */
        interface GrafastInterfaceTypeConfig<TSource, TContext> extends Omit<GraphQLInterfaceTypeConfig<TSource, TContext>, "fields" | "interfaces"> {
            fields?: GraphQLFieldConfigMap<TSource, TContext> | ((context: ContextInterfaceFields) => GraphQLFieldConfigMap<TSource, TContext>);
            interfaces?: GraphQLInterfaceType[] | ((context: ContextInterfaceInterfaces) => GraphQLInterfaceType[]);
        }
        /**
        ...
        interface BuildBase {
             ...
             */
            hasVersion(packageName: string, range: string, options?: {
            ...
            registerInterfaceType: (typeName: string, scope: ScopeInterface, specGenerator: () => Omit<GrafastInterfaceTypeConfig<any, any>, "name">, origin: string | null | undefined) => void;
            /** As registerObjectType, but for unions */
            registerUnionType: (typeName: string, scope: ScopeUnion, specGenerator: () => Omit<GrafastUnionTypeConfig<any, any>, "name">, origin: string | null | undefined) => void;
            /** As registerObjectType, but for scalars */
            registerScalarType: (typeName: string, scope: ScopeScalar, specGenerator: () => Omit<GraphQLScalarTypeConfig<any, any>, "name">, origin: string | null | undefined) => void;
            /** As registerObjectType, but for enums */
            registerEnumType: (typeName: string, scope: ScopeEnum, specGenerator: () => Omit<GraphQLEnumTypeConfig, "name">, origin: string | null | undefined) => void;
            /** As registerObjectType, but for input objects */
            registerInputObjectType: (typeName: string, scope: ScopeInputObject, specGenerator: () => Omit<GrafastInputObjectTypeConfig, "name">, origin: string | null | undefined) => void;
            /**
             ...
             */
            extend: <Obj1 extends object, Obj2 extends Partial<Obj1> & object>(base: Obj1, extra: Obj2, hint: string, behaviourOnConflict?: "throw" | "recoverable") => Obj1 & Obj2;
            getAllTypes(): {
             ...
             */
            nullableIf<T extends GraphQLType>(condition: boolean, type: T): T | GraphQLNonNull<T>;
            _pluginMeta: {
        ...
        interface Context {
            scope: Scope;
            type: "build" | "init" | "finalize" | "GraphQLSchema" | "GraphQLScalarType" | "GraphQLObjectType" | "GraphQLInterfaceType" | "GraphQLUnionType" | "GraphQLEnumType" | "GraphQLInputObjectType";
        }
        ...
        interface ContextInterfaceFieldsFieldArgs extends ContextInterfaceFieldsField {
         ...
         */
        type SomeScope = Scope | ScopeBuild | ScopeInit | ScopeSchema | ScopeSchemaTypes | ScopeScalar | ScopeObject | ScopeObjectInterfaces | ScopeObjectFields | ScopeObjectFieldsField | ScopeObjectFieldsFieldArgs | ScopeInterface | ScopeUnion | ScopeUnionTypes | ScopeInputObject | ScopeInputObjectFields | ScopeInputObjectFieldsField | ScopeEnum | ScopeEnumValues | ScopeEnumValuesValue | ScopeFinalize;
        /**
         * A Graphile-Build hook function.
         */
        type Hook<Type, TContext extends Context, TBuild extends Partial<Build> = Build> = {
         ...
         * non-trivial fields.
         */
        type FieldWithHooksFunction = <TType extends GraphQLOutputType, TContext extends Grafast.Context, TParentStep extends ExecutableStep, TFieldStep extends OutputPlanForType<TType>, TArgs extends BaseGraphQLArguments>(fieldScope: ScopeObjectFieldsField, spec: GrafastFieldConfig<TType, TContext, TParentStep, TFieldStep, TArgs> | ((context: ContextObjectFieldsField) => GrafastFieldConfig<TType, TContext, TParentStep, TFieldStep, TArgs>)) => GrafastFieldConfig<TType, TContext, TParentStep, TFieldStep, TArgs>;
        ...
        type InputFieldWithHooksFunction = (fieldScope: ScopeInputObjectFieldsField, spec: GrafastInputFieldConfig<any, any, any, any, any> | ((context: ContextInputObjectFieldsField) => GrafastInputFieldConfig<any, any, any, any, any>)) => GrafastInputFieldConfig<any, any, any, any, any>;
        /**
         * These are all of the hooks that graphile-build supports and the types of
         * the various parameters to the hook function.
         */
        interface SchemaBuilderHooks<TBuild extends GraphileBuild.Build = GraphileBuild.Build> {
            /**
             ...
             */
            build: GraphileBuild.Hook<Partial<TBuild> & GraphileBuild.BuildBase, GraphileBuild.ContextBuild, Partial<TBuild> & GraphileBuild.BuildBase>[];
            /**
             ...
             */
            init: GraphileBuild.Hook<Record<string, never>, GraphileBuild.ContextInit, TBuild>[];
            /**
             ...
             */
            finalize: GraphileBuild.Hook<GraphQLSchema, GraphileBuild.ContextFinalize, TBuild>[];
            /**
             * Add 'query', 'mutation' or 'subscription' types in this hook:
             */
            GraphQLSchema: GraphileBuild.Hook<GraphQLSchemaConfig, GraphileBuild.ContextSchema, TBuild>[];
            /**
             * Add any types that need registering (typically polymorphic types) here
             */
            GraphQLSchema_types: GraphileBuild.Hook<GraphQLNamedType[], GraphileBuild.ContextSchemaTypes, TBuild>[];
            /**
             ...
             */
            GraphQLObjectType: GraphileBuild.Hook<GrafastObjectTypeConfig<any, any>, GraphileBuild.ContextObject, TBuild>[];
            GraphQLObjectType_interfaces: GraphileBuild.Hook<GraphQLInterfaceType[], GraphileBuild.ContextObjectInterfaces, TBuild>[];
            GraphQLObjectType_fields: GraphileBuild.Hook<GrafastFieldConfigMap<any, any>, GraphileBuild.ContextObjectFields, TBuild>[];
            GraphQLObjectType_fields_field: GraphileBuild.Hook<GrafastFieldConfig<any, any, any, any, any>, GraphileBuild.ContextObjectFieldsField, TBuild>[];
            GraphQLObjectType_fields_field_args: GraphileBuild.Hook<GrafastFieldConfigArgumentMap<any, any, any, any>, GraphileBuild.ContextObjectFieldsFieldArgs, TBuild>[];
            GraphQLObjectType_fields_field_args_arg: GraphileBuild.Hook<GrafastArgumentConfig<any, any, any, any, any, any>, GraphileBuild.ContextObjectFieldsFieldArgsArg, TBuild>[];
            /**
             ...
             */
            GraphQLInputObjectType: GraphileBuild.Hook<GraphileBuild.GrafastInputObjectTypeConfig, GraphileBuild.ContextInputObject, TBuild>[];
            GraphQLInputObjectType_fields: GraphileBuild.Hook<GraphQLInputFieldConfigMap, GraphileBuild.ContextInputObjectFields, TBuild>[];
            GraphQLInputObjectType_fields_field: GraphileBuild.Hook<GrafastInputFieldConfig<any, any, any, any, any>, GraphileBuild.ContextInputObjectFieldsField, TBuild>[];
            /**
             ...
             */
            GraphQLEnumType: GraphileBuild.Hook<GraphQLEnumTypeConfig, GraphileBuild.ContextEnum, TBuild>[];
            GraphQLEnumType_values: GraphileBuild.Hook<GraphQLEnumValueConfigMap, GraphileBuild.ContextEnumValues, TBuild>[];
            GraphQLEnumType_values_value: GraphileBuild.Hook<GraphQLEnumValueConfig, GraphileBuild.ContextEnumValuesValue, TBuild>[];
            /**
             ...
             */
            GraphQLUnionType: GraphileBuild.Hook<GraphileBuild.GrafastUnionTypeConfig<any, any>, GraphileBuild.ContextUnion, TBuild>[];
            GraphQLUnionType_types: GraphileBuild.Hook<GraphQLObjectType[], GraphileBuild.ContextUnionTypes, TBuild>[];
            /**
             ...
             */
            GraphQLInterfaceType: GraphileBuild.Hook<GraphileBuild.GrafastInterfaceTypeConfig<any, any>, GraphileBuild.ContextInterface, TBuild>[];
            GraphQLInterfaceType_fields: GraphileBuild.Hook<GraphQLFieldConfigMap<any, any>, GraphileBuild.ContextInterfaceFields, TBuild>[];
            GraphQLInterfaceType_fields_field: GraphileBuild.Hook<GraphQLFieldConfig<any, any>, GraphileBuild.ContextInterfaceFieldsField, TBuild>[];
             ...
             * For scalars
             */
            GraphQLScalarType: GraphileBuild.Hook<GraphQLScalarTypeConfig<any, any>, GraphileBuild.ContextScalar, TBuild>[];
        }
    }
}
 ...
 */
export type SpecForType<TType extends GraphQLNamedType | GraphQLSchema> = TType extends GraphQLSchema ? Partial<GraphQLSchemaConfig> : TType extends GraphQLObjectType ? Partial<GraphileBuild.GrafastObjectTypeConfig<any, any>> & {
    name: string;
} : TType extends GraphQLInterfaceType ? Partial<GraphileBuild.GrafastInterfaceTypeConfig<any, any>> & {
    name: string;
} : TType extends GraphQLUnionType ? Partial<GraphileBuild.GrafastUnionTypeConfig<any, any>> & {
    name: string;
} : TType extends GraphQLScalarType ? Partial<GraphQLScalarTypeConfig<any, any>> & {
    name: string;
} : TType extends GraphQLEnumType ? Partial<GraphQLEnumTypeConfig> & {
    name: string;
} : TType extends GraphQLInputObjectType ? Partial<GraphileBuild.GrafastInputObjectTypeConfig> & {
    name: string;
} : never;
