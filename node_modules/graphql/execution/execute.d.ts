...
export declare class Dispatcher {
  ...
  _throw(error?: unknown): Promise<IteratorResult<AsyncExecutionResult, void>>;
  get(
    initialResult: ExecutionResult,
  ): AsyncGenerator<AsyncExecutionResult, void, void>;
}
export declare class AsyncPayloadContext {
  errors: Array<GraphQLError>;
  label?: string;
  path?: Path;
  dataPromise?: Promise<unknown>;
  constructor(opts: { label?: string; path?: Path });
  addDataPromise(promise: Promise<unknown>): void;
}
export {};
