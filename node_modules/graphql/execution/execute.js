...
exports.Dispatcher = exports.AsyncPayloadContext = void 0;
...
function executeOperation(exeContext, operation, rootValue) {
  ...
  const { fields: rootFields, patches } = (0, _collectFields.collectFields)(
    exeContext.schema,
    exeContext.fragments,
    exeContext.variableValues,
    rootType,
...
function getStreamValues(exeContext, fieldNodes) {
  ...
  stream.initialCount >= 0 ||
    (0, _invariant.invariant)(false, 'initialCount must be a positive integer');
  return {
...
exports.AsyncPayloadContext = AsyncPayloadContext;
