        ...
        hooks: {
            async pgCodecs_PgCodec(info, event) {
                ...
                for (const ref of refs) {
                    const { args: [name], params: { to, plural: rawPlural, singular: rawSingular, via: rawVia, behavior, }, } = ref;
            ...
            async pgTables_PgResourceOptions_relations_post(info, event) {
                ...
                const getCodecForTableName = async (targetTableIdentifier) => {
                    ...
                    const [targetSchemaName, targetTableName] = (0, utils_js_1.parseDatabaseIdentifierFromSmartTag)(targetTableIdentifier, 2, nsp.nspname);
