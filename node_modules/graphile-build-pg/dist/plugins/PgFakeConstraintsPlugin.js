...
ALTER TABLE ${(0, pg_sql2_1.escapeSqlIdentifier)(foreignSchema)}.${(0, pg_sql2_1.escapeSqlIdentifier)(foreignTable)}
  ADD UNIQUE (${foreignKeyAttibutes
                .map((k) => (0, pg_sql2_1.escapeSqlIdentifier)(k.attname))
                .join(", ")});
...
function addConstraintToClass(introspection, pgConstraint, oid, foreign = false) {
    if (oid != null) {
        const pgClass = introspection.classes.find((rel) => rel._id === pgConstraint.conrelid);
        if (!pgClass) {
