        ...
        helpers: {
            getCodecFromClass(info, serviceName, classId) {
                ...
                const promise = (async () => {
                    ...
                    for (const attributeAttribute of attributeAttributes) {
                        ...
                        if (attributeCodec) {
                            ...
                            if (attributeAttribute.attidentity === "a") {
                                ...
                                (0, utils_js_1.addBehaviorToTags)(tags, "-attribute:insert -attribute:update", true);
                            }
                    ...
                    const spec = (0, graphile_build_1.EXPORTABLE)((attributes, className, codecName, description, extensions, nspName, sql) => ({
                        name: codecName,
