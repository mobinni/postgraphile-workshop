    ...
    inflection: {
        add: {
            allRowsConnection(options, resource) {
                return this.connectionField(this.camelCase(`all-${this.pluralize(this._singularizedResourceName(resource))}`));
            },
            allRowsList(options, resource) {
                return this.listField(this.camelCase(`all-${this.pluralize(this._singularizedResourceName(resource))}`));
            },
        },
    },
    schema: {
