...
exports.PgMutationCreatePlugin = {
    ...
    schema: {
        ...
        hooks: {
            init(_, build) {
                const { inflection, graphql: { GraphQLString, GraphQLNonNull }, } = build;
                        ...
                        build.registerObjectType(payloadTypeName, {
                            ...
                            fields: ({ fieldWithHooks }) => {
                                ...
                                return {
                                    clientMutationId: {
                                        type: GraphQLString,
                                        plan: (0, graphile_build_1.EXPORTABLE)((constant) => function plan($mutation) {
                                            return ($mutation.getStepForKey("clientMutationId", true) ?? constant(null));
                                        }, [grafast_1.constant]),
                                    },
                                    ...(TableType &&
                                        build.behavior.pgResourceMatches(resource, "insert:payload:record")
                                        ? {
                                            [tableFieldName]: fieldWithHooks({
                                                fieldName: tableFieldName,
