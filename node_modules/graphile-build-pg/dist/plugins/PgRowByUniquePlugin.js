...
return function (resource) {
  return (_$root, args) => resource.get({ ${tamedevil_1.default.join(attributeNames.map((attributeName) => (0, tamedevil_1.default) `${tamedevil_1.default.dangerousKey(attributeName)}: args.get(${tamedevil_1.default.lit(detailsByAttributeName[attributeName].graphqlName)})`), ", ")} });
}`, [resource])
                        : (0, graphile_build_1.EXPORTABLE)((detailsByAttributeName, resource) => function plan(_$root, args) {
                            ...
                            for (const attributeName in detailsByAttributeName) {
                                spec[attributeName] = args.get(detailsByAttributeName[attributeName]
                                    .graphqlName);
                            }
