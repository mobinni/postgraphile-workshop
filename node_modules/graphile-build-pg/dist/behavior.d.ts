 ...
 */
export declare function getBehavior(extensions: ArrayOrDirect<Partial<PgResourceExtensions | PgCodecRelationExtensions | PgCodecExtensions | PgCodecRefExtensions> | undefined>): string;
export {};
