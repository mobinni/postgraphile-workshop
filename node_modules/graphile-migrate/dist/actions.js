    ...
    for (const actionSpec of actions) {
        ...
        if (actionSpec._ === "sql") {
            ...
            const promise = exec(actionSpec.command, {
                env: lib_1.mergeWithoutClobbering(Object.assign(Object.assign({}, process.env), { DATABASE_URL: exports.DO_NOT_USE_DATABASE_URL }), Object.assign(Object.assign(Object.assign({ GM_DBNAME: databaseName }, (actionSpec.root
                    ? null
                    : {
                        GM_DBUSER: databaseUser,
                    })), { GM_DBURL: hookConnectionString }), (shadow
                    ? {
                        GM_SHADOW: "1",
                    }
